...
class UC4_DeleteEntry {
    ...
    public static void main(String[] args) {
        System.out.println("this is address book delete entry feature");
        UC4_DeleteEntry deleteEntry = new UC4_DeleteEntry();


        deleteEntry.addContact(deleteEntry.getContactDetails());
        deleteEntry.displayContactDetails();
        System.out.println("Enter 1 to edit");
        System.out.println("Enter 2 to delete");
        Scanner scn = new Scanner(System.in);
        int choice = scn.nextInt();
        if (choice == 1) {
            deleteEntry.editContact();
